...
export const groups = pgTable('groups', {
  ...
  photoCompletedAt: timestamp('photo_completed_at', { withTimezone: true }),
  ...
  nameSetAt: timestamp('name_set_at', { withTimezone: true }), // null until the leader deliberately names the group; the placeholder auto-name at creation doesn't count

  // Kelompok yang memilih mengerjakan yel-yel belakangan. Bukti yang masuk
  // setelah ini dinilai dengan tarif yang lebih rendah.
  yelYelSkippedAt: timestamp('yel_yel_skipped_at', { withTimezone: true }),
