 ...
 *
 * Bukan sesi login: yang di seberang adalah sebuah sistem, bukan orang, dan ia
 * tidak bertindak atas nama siapa pun di sini. Kuncinya dikirim di header
 ...
 * Endpoint yang bisa mengubah angka penentu juara tidak boleh pernah menganggap
 * "belum dikonfigurasi" sama dengan "bebas dipakai siapa saja".
 */
